...
import com.metacontent.lovelyheads.block.entity.HeadConstructorBlockEntity;
...
public class HeadConstructorBlock extends BlockWithEntity {
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    public HeadConstructorBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new HeadConstructorBlockEntity(pos, state);
    }
